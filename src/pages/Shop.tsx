...
const products = [
  ...
  },
  {
    ...
    group: "Bolsos",
    category: "Bolsos",
    description: "Bolso cruzado chico con panel en piel grabada tipo avestruz.",
  ...
  },
  {
    ...
    group: "Carteras",
    category: "Carteras",
    description: "Clutch grande en piel grabada tipo cocodrilo, cierre y cadena dorados.",
